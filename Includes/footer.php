<div class="footer">
    <div class="container">
        <div class="w3_footer_grids">
            <div class="col-md-3 w3_footer_grid">
                ...
                <ul class="address">
                    <li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>141 , mysore taluk
                        <span>India.</span>
                    </li>
                    <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a
                            href="mailto:info@example.com">notes2free@gmail.com</a></li>
                    <li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+91 9964716807</li>
                </ul>
            </div>
            <div class="col-md-3 w3_footer_grid">
                <h3>Information</h3>
    ...
    <div class="footer-copy">
        ...
        <div class="container">
            <p>© 2023 Super Market Management System. All rights reserved | Design by <a
                    href="https://www.notes2free.comm">Notes2free</a>
            </p>
        </div>
    </div>
